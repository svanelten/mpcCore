...
{
	/// <summary>
	/// Listing of all items and directories for the given path, recognized by MPD or not - this means also .db, .dat etc
	...
	/// </summary>
	public class ListFiles : DirectoryCommandBase
	{
		/// <summary>
		/// <inheritdoc/>
		/// </summary>
